...
<body>
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=5c64487a2bc34f26ca438a731c49428a"></script>
	<script>
		...
		var placePosition = new kakao.maps.LatLng(37.45674659, 126.6413020);
...
//		roadview.setPanoId(1023434522, placePosition);
		...
		kakao.maps.event.addListener(mapMarker, 'click', function() {
			...
			roadviewClient.getNearestPanoId(position, 50, function(panoId) {
			    roadview.setPanoId(panoId, position1);
			});
